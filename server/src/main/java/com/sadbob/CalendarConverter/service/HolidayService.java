...
public class HolidayService {
    ...
    private void initializeSampleHolidays() {
        ...
        // Ethiopian Holidays (CORRECTED DATES)
        ...
        sampleHolidays.add(new Holiday("Timkat", "Epiphany", CalendarType.ETHIOPIAN, HolidayType.RELIGIOUS, 11, 5, "ET")); // Fixed: Month 5, Day 11
        ...
        // Islamic Holidays (ADD RAMADAN)
        sampleHolidays.add(new Holiday("Ramadan", "Month of Fasting", CalendarType.HIJRI, HolidayType.RELIGIOUS, 1, 9, null)); // Added Ramadan
        ...
        // Gregorian Holidays (FIX EASTER DATE)
        ...
        sampleHolidays.add(new Holiday("Easter", "Easter Sunday", CalendarType.GREGORIAN, HolidayType.RELIGIOUS, 9, 4, null)); // Fixed: April 9, 2023
